...
export function ApiKeysTable({ apiKeys, isLoading, onRevoke, onDelete, readOnly }: ApiKeysTableProps) {
  ...
  const totalPages = Math.ceil(activeKeys.length / pageSize);
  const paginatedKeys = activeKeys.slice((page - 1) * pageSize, page * pageSize);
              ...
              <TableRow key={key.id}>
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <code className="text-sm bg-gray-100 px-2 py-1 rounded-xl">
